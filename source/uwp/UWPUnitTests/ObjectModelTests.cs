...
namespace UWPUnitTests
{
    ...
    public class ObjectModelTest
    {
        ...
        public void Card()
        {
            ...
            Assert.AreEqual(1, card.Authentication.Buttons);
